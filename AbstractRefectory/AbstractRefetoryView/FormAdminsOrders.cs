...
{
    public partial class FormAdminsOrders : Form
    {

        [Dependency]
        public new IUnityContainer Container { get; set; }
        private readonly IReptService service;
        public FormAdminsOrders(IReptService service)
        {
            InitializeComponent();
        ...
        private void buttonMake_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               ...
               dateTimePickerTo.Value.ToShortDateString());
                ...
                var dataSource = service.GetAdminOrders(new ReptBindingModel
                {
        ...
        private void buttonToPdf_Click(object sender, EventArgs e)
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    service.SaveAdminOrders(new ReptBindingModel
                    {
